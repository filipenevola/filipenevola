...
export const SITE_WHY_EXISTS = {
  ...
  paragraphs: [
    ...
    'Aqui reunimos notícias com critério (crawler + curadoria), opiniões e vídeos no nosso tom, e uma agenda de jogos útil — sempre com pé no chão: otimista quando faz sentido, realista quando precisa, longe do sensacionalismo.',
