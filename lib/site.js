...
export const SITE_WHY_EXISTS = {
  ...
  paragraphs: [
    ...
    'Criamos o Palmeiras App para quem ama o clube e quer se informar, opinar e marcar os jogos sem virar refém de humor de internet ou de comentarista que só vende emoção.',
...
export const PAGE_META = {
  inicio: {
    title: 'Início',
    description:
      'Uma forma mais saudável de viver o Palmeiras no emocional — notícias, opiniões e jogos sem sensacionalismo.',
    ogType: 'inicio',
    badge: 'Início',
  },
  noticias: {
  ...
  sobre: {
    title: 'Sobre',
    description:
      'Uma forma mais saudável de viver o Palmeiras no emocional — nossa proposta editorial.',
    ogType: 'sobre',
    badge: 'Sobre',
