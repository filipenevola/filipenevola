...
export const SITE_MISSION =
  'Uma forma mais saudável de torcer para o Palmeiras.';
...
export const SITE_WHY_EXISTS = {
  ...
  paragraphs: [
    'Torcer não precisa ser montanha-russa emocional todo dia. Queremos uma forma mais saudável de torcer para o Palmeiras: informado, engajado e sem aquele nó no estômago depois de cada notificação.',
...
export const PAGE_META = {
  inicio: {
    title: 'Início',
    description:
      'verdaoracional — uma forma mais saudável de torcer para o Palmeiras.',
    ogType: 'inicio',
    badge: 'Início',
  },
  noticias: {
  ...
  sobre: {
    title: 'Sobre',
    description:
      'verdaoracional — torcer para o Palmeiras com equilíbrio e sem sensacionalismo.',
    ogType: 'sobre',
    badge: 'Sobre',
