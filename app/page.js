      ...
      <div className="flex flex-col justify-center items-center space-y-4 w-full md:w-3/4 xl:w-1/2">
        ...
        <div className="flex flex-col space-y-4">
          <p>
            ...
            <a href="https://quave.dev" className="underline">
              Quave
            </a>
            's CEO, Developer & Instructor trying to be better every day.
          </p>

          <p>
            My{' '}
            <a href="https://news.lemeno.io/filipe-nevola" className="underline">
              Newsletter
            </a>
            .
          </p>
          ...
          <p>
            ...
            <a href="https://codeftw.dev" className="underline">
              CodeFTW
            </a>{' '}
            (Free and in Portuguese) and{' '}
            <a href="https://aiproofdev.com" className="underline">
              AIProofDev
            </a>{' '}
            (Paid and in English).
          </p>
        </div>
        <div className="font-semibold pt-4">X Threads</div>
        ...
        <div className="font-semibold pt-4">Articles</div>
        <ul className="space-y-2">
          <li>
            <a href="https://dev.to/filipenevola" target="_blank">
